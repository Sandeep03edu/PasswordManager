...
const DisplayRecentCredential = () => {
  ...
  return (
    <div className="m-0 bg-white rounded px-2" style={{ width: "100%" }}>
      <div className="container m-0" style={{ minWidth: "100%" }}>
        <h2 className="pb-3 pt-2">Recent Credentials</h2>
          ...
          <tbody>
            {dummyData.map((data) => (
              <tr
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.backgroundColor = "rgba(0, 0, 0, 0.05)"; // Add transparent background color on hover
                }}
                onMouseLeave={(e) => {
